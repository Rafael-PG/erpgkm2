        ...
        <table>
            ...
            <tbody>
                @foreach($modelos as $modelo)
                    <tr>
                        <td>{{ $modelo->nombre }}</td>
                        <td>{{ $modelo->marca->nombre ?? 'Sin Marca' }}</td> <!-- Relación con marca -->
                        <td>{{ $modelo->categorium->nombre ?? 'Sin Categoría' }}</td> <!-- Relación con categoría -->
                        <td>
                            <span class="badge {{ $modelo->estado ? 'badge-success' : 'badge-danger' }}">
