...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de lenguaje personalizadas para la validación
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes personalizados de validación para atributos usando
    | la convención "atributo.regla" para nombrar las líneas. Esto ayuda a mantener los mensajes claros.
    |
    */
