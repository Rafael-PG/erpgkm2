...
// Aquí va el código para el formulario de órdenes
    ...
    fetch('/ordenes/store', {
        ...
        .then((data) => {
            if (data.success) {
                ...
                showMessage('Orden agregada correctamente.', 'top-end');
                ...
                showMessage('Hubo un error al guardar la orden.', 'top-end', true, '', 3000, 'error');
            }
        })
        .catch((error) => {
